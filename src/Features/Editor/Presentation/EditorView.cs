...
public partial class EditorView : ReactiveUserControl<EditorViewModel>, IDisposable, IEditorLanguageOperations
{
        ...
        DebugCurrentLocationViewModel currentLocationViewModel)
    {
        ...
        ThemeBinding.SetBrush(_textEditor, TextEditor.BackgroundProperty, "SurfaceBaseBrush");
        ThemeBinding.SetBrush(_textEditor, TextEditor.ForegroundProperty, "TextPrimaryBrush");
        ...
        this.WhenActivated(d =>
        {
            ...
            d.Add(EditorLanguageUiProjection.Subscribe(
                ...
                ApplyHoverSnapshot));
            d.Add(EditorLanguageUiProjection.Subscribe(
                _languageInput.NavigationWhenChanged,
                _uiDispatcher,
                ApplyNavigationSnapshot));
            d.Add(EditorLanguageUiProjection.Subscribe(
                _languageInput.SymbolWhenChanged,
                _uiDispatcher,
                ApplySymbolSnapshot));
