...
(DAP debugging) has completed M0 planning/proof through M4 execution controls
and the Debug Console / Call Stack bottom panel; M5 stack and variables
projection is next. Phase 13 remains ahead. Zaide currently has the IDE
