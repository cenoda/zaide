...
6.3 M1–M5 and M6a–M6g are complete** as individually completed slices. **M6g**
(Townhall registration module) is complete at `1f18e49` (`AddZaideTownhall`).
**M6h** is the next eligible slice and requires separate explicit authorization;
M6h has not started. **M6i–M6k** remain unauthorized, and the whole M6 series
is not complete.
...
seventh completed M6 slice). **M6h** (SourceControl registration module) is the
next eligible milestone slice and still requires separate explicit
authorization. M6h has not started; M6i–M6k remain unauthorized. Completing
M6g does not authorize later M6 slices. Phase 14 and every preceding refactor
