...
[Roadmap V3 — AI-Native Orchestration](docs/roadmap/V3.md) has a **complete
and technically closed implementation sequence** (2026-07-29), but product
...
21](docs/phases/v3/phase-21/IMPLEMENTATION_PLAN.md) M0–M7 are complete, published, and accepted; **M6 memory influence and integrated management is complete and published** (`928a17c801f664bd43896d10cff2cde2ed968934`, publication-record correction `85af80d3f89fa25288f5282654da6267bdba9e3a`); **M7 adversarial and release closeout is complete and published** (`4ec4f31febfb963e5373d72b749519c788d319cf`, publication-record correction `e0ca36b3f70e2319d317d70874f10c3006ac582a`; final closeout `docs(phase-21): accept final closeout`). External candidate/provider smoke remains not executed (separate authorization not provided). Phase 22 critical path is in progress: 22.1 complete; 22.2 package-2 PASS restored against the live ACP baseline; 22.3 and 22.4 pending separate authorization; G5 and V4 remain blocked. See
`docs/phases/v3/phase-19/TOFIX.md`,
`docs/phases/v3/phase-20/TOFIX.md`,
`docs/phases/v3/phase-21/TOFIX.md`, and
`docs/phases/v3/phase-22/TOFIX.md`.
...
The default test command uses eight conservative xUnit workers for fast
...
known parallel-runner hang. Some Avalonia, PTY, and process-global tests are
not parallel-safe. Reproduce fast-mode failures with the opt-in serial
configuration before treating them as regressions:
...
[Roadmap V3](docs/roadmap/V3.md) has a complete and technically closed
implementation sequence while preserving the completed V2 IDE core. It
delivered:
...
This technical closeout is not product-readiness acceptance. Before V4 or any
successor implementation, a clean-profile V1–V3 product reality audit must
compare the documented goals, live production wiring, and actual
user-observable workflows. Existing issues and deferred findings are initial
symptoms rather than an exhaustive inventory. V4 remains blocked pending an
...
M0–M7 are complete, published, and accepted; **M6 memory influence and integrated management is complete and published** (`928a17c801f664bd43896d10cff2cde2ed968934`, publication-record correction `85af80d3f89fa25288f5282654da6267bdba9e3a`); **M7 adversarial and release closeout is complete and published** (`4ec4f31febfb963e5373d72b749519c788d319cf`, publication-record correction `e0ca36b3f70e2319d317d70874f10c3006ac582a`; final closeout `docs(phase-21): accept final closeout`). External candidate/provider smoke remains not executed (separate authorization not provided). Roadmap V3's original implementation sequence is technically closed; product-readiness acceptance remains withheld pending Phase 22 corrective packages 1–7 and G5. Phase 22 critical path is in progress: 22.1 complete; 22.2 package-2 PASS restored against the live ACP baseline; 22.3 and 22.4 pending separate authorization; G5 and V4 remain blocked.
