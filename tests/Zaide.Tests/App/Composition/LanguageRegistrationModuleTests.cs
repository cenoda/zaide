...
public sealed class LanguageRegistrationModuleTests
{
    ...
    public void ProgramSource_CallsAddZaideLanguageOnce_AndDoesNotDeclareLanguageRegistrations()
    {
        ...
        // All ten M6k Debugging registrations remain direct in Program.
        ...
        // M6k Debugging module does not exist yet.
    ...
    public void ProgramSource_StillDeclaresM6kPlusRegistrationsDirectly()
    {
        ...
        // M6j Language module is present; M6k Debugging module does not exist yet.
        Assert.Single(Regex.Matches(programSource, @"AddZaideLanguage\s*\(\s*\)"));
        Assert.DoesNotContain("AddZaideDebugging", programSource);
    }
