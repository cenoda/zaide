...
/// </summary>
public sealed class Phase13M4aCriticalPathEvidenceTests
{
    ...
    public async Task EditAndSave_WorkflowConsole_OpenEditSaveRestore_Passes()
    {
        ...
        var sourceShaBefore = Phase13M0EditorMeasurementSeam.Sha256Hex(FixtureProgram);
        ...
        Assert.Equal(sourceShaBefore, Phase13M0EditorMeasurementSeam.Sha256Hex(FixtureProgram));
    }
}
