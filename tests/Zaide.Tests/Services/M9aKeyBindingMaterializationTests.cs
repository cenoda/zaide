...
/// </summary>
public sealed class M9aKeyBindingMaterializationTests
{
    static M9aKeyBindingMaterializationTests()
    {
    ...
    public M9aKeyBindingMaterializationTests()
    {
    ...
    public void ResolveAndConvert_ProducesBindingsForAllResolvedGestures()
    {
        ...
        // Expect 7 bindings: Ctrl+S, Ctrl+O, Ctrl+Oem3, Ctrl+J, Ctrl+Shift+H, Ctrl+Shift+B, Ctrl+F5
    ...
    public void ReplaceBindings_PreservesUnrelatedBindings()
    {
        ...
        Materialize();
        Assert.Equal(8, keyBindings.Count); // 1 unrelated + 7 registry
