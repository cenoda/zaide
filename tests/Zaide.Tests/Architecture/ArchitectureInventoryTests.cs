...
public sealed class ArchitectureInventoryTests
{
    ...
    public void Read_ReproducesM0TopLevelVisibilityBaseline()
    {
        ...
        Assert.Equal((8, 0, 8), byNamespace["Zaide.App.Composition.Registration"]);
    ...
    public void Read_SourceFolderPlacement_MatchesM0TrackedFileCounts()
    {
        ...
        // Post-M1+M2: 356 base → 358 (M1) → 360 (M2); M5 −1; M6a +1; M6b +1; M6c +1; M6d +1; M6e +1; M6f +1; M6g +1; M6h +1 SourceControl module.
        Assert.Equal(367, inventory.SourceFiles.Count);
