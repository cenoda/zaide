...
public sealed class ArchitectureInventoryTests
{
    ...
    public void Read_ReproducesM0TopLevelVisibilityBaseline()
    {
        ...
        Assert.Equal((2, 0, 2), byNamespace["Zaide.App.Composition.Registration"]);
    ...
    public void Read_SourceFolderPlacement_MatchesM0TrackedFileCounts()
    {
        ...
        // Post-M1+M2: 356 base → 358 (M1) → 360 (M2); M5 −1; M6a +1; M6b +1 Settings module.
        Assert.Equal(361, inventory.SourceFiles.Count);
