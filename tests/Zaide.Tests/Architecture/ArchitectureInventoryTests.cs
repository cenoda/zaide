...
public sealed class ArchitectureInventoryTests
{
    ...
    public void Read_ReproducesM0TopLevelVisibilityBaseline()
    {
        ...
        // Refactor 10 M4b: +4 AppButton/AppTextBox/ListRow/PanelChrome.
        Assert.Equal((11, 2, 9), byNamespace["Zaide.UI.DesignSystem"]);
        ...
        // ISSUE-011: +1 internal CodeFontResolver.
        Assert.Equal((20, 13, 7), byNamespace["Zaide.Features.Editor.Presentation"]);
        ...
        // Phase 21 M4: +5 internal session continuity contracts.
        Assert.Equal((5, 0, 5), byNamespace["Zaide.Features.Agents.Contracts.Continuity"]);
        ...
        // Phase 22.3 M4 corrective: +2 internal invocation counter types.
        ...
        Assert.Equal((24, 0, 24), byNamespace["Zaide.Features.Agents.Application.Acp"]);
        ...
        // Phase 20 M5: +2 internal ACP authenticate wire and stdio session client types.
        Assert.Equal((69, 0, 69), byNamespace["Zaide.Features.Agents.Infrastructure.Acp"]);
        ...
        // Phase 23 F1: +1 internal AgentInspectHost.
        Assert.Equal((10, 3, 7), byNamespace["Zaide.Features.Agents.Presentation"]);
    ...
    public void Read_SourceFolderPlacement_MatchesM0TrackedFileCounts()
    {
        ...
        // Refactor 10 M4b: +4 AppButton/AppTextBox/ListRow/PanelChrome (895).
        Assert.Equal(895, inventory.SourceFiles.Count);
