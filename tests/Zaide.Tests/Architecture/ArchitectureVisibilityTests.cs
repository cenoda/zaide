...
public sealed class ArchitectureVisibilityTests
{
    ...
    public void ExpandedRootFolderAdmission_DenyUnauthorizedFoldersAndRoots()
    {
        ...
        // DesignSystem only (M1); Features admits Settings + Workspace + Editor + ProjectSystem (M2–M5b).
        ...
        Assert.Equal(105, inventory.SourceFiles.Count(f => f.TechnicalFolder == "Features"));
    }
