...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (M8 +1 ApplicationShutdown).</summary>
    public const int TotalTopLevelTypes = 410;
    ...
    /// <summary>Internal top-level production type count (M8 +1 ApplicationShutdown).</summary>
    public const int InternalTopLevelTypes = 64;
