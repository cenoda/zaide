...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (M6i +1 internal DI module).</summary>
    public const int TotalTopLevelTypes = 406;
    ...
    /// <summary>Internal top-level production type count (M6i +1 ProjectSystem registration extension).</summary>
    public const int InternalTopLevelTypes = 60;
