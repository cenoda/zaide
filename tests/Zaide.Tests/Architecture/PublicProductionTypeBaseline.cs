...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (Phase 21 M1 +26 durable-record/storage types; Phase 20 M5 baseline 794).</summary>
    public const int TotalTopLevelTypes = 820;
    ...
    /// <summary>Internal top-level production type count (Phase 21 M1 +26 durable-record/storage types; Phase 20 M5 baseline 443).</summary>
    public const int InternalTopLevelTypes = 469;
