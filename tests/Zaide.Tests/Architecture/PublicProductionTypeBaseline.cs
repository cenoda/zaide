...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (M7 +1 CompositionRoot).</summary>
    public const int TotalTopLevelTypes = 409;
    ...
    /// <summary>Internal top-level production type count (M7 +1 CompositionRoot store).</summary>
    public const int InternalTopLevelTypes = 63;
