...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (Phase 17 M2 corrective +1 internal authority).</summary>
    public const int TotalTopLevelTypes = 558;
    ...
    /// <summary>Internal top-level production type count (Phase 17 M2 corrective +1 internal authority).</summary>
    public const int InternalTopLevelTypes = 221;
