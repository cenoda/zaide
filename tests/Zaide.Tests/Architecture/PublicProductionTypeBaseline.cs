...
public static class PublicProductionTypeBaseline
{
    ...
    /// <summary>Total non-nested, non-compiler-generated production types (Phase 20 M3 +13 ACP backend adapter types; Phase 20 M2 baseline 750).</summary>
    public const int TotalTopLevelTypes = 763;
    ...
    /// <summary>Internal top-level production type count (Phase 20 M3 +13 ACP backend adapter types; Phase 20 M2 baseline 400).</summary>
    public const int InternalTopLevelTypes = 413;
