...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Refactor 8 M1 +2 internal DesignSystem token helpers).</summary>
    public const int M0TotalTopLevelTypes = 445;
    ...
    /// <summary>M0 baseline internal top-level type count (Refactor 8 M1 +2 DesignSystem token helpers).</summary>
    public const int M0InternalTopLevelTypes = 106;
