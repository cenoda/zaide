...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Refactor 8 M2 +1 internal BottomPanelHost).</summary>
    public const int M0TotalTopLevelTypes = 446;
    ...
    /// <summary>M0 baseline internal top-level type count (Refactor 8 M2 +1 BottomPanelHost).</summary>
    public const int M0InternalTopLevelTypes = 107;
