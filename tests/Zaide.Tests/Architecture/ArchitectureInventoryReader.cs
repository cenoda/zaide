...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Refactor 10 M4b +4 AppButton/AppTextBox/ListRow/PanelChrome; Refactor 10 M4a +1 ControlThemeCatalog; Refactor 10 M2 +1 Elevation; Refactor 10 M1 +3 ThemeBinding/ThemeTokenParityTests/Light.axaml; Phase 23 F1 +1 AgentInspectHost; Phase 22.4 M3 +3 AgentUsagePanel/AgentUsageSurfaceState/AgentUsageAggregationSemantics; Phase 22.4 M2 +2 AgentMemoryPanel/AgentMemorySurfaceState; Phase 22.3 M4 corrective +2 invocation counter types; Phase 22.3 M2 residual +3 cancel-ack seam types; Phase 22.3 M2 +2 AgentSessionEndStatus/Result; Phase 22.2 corrective +1 ACP runtime binding fingerprint; Phase 22.2 M1 +13 durable binding store types; ISSUE-011 +1 CodeFontResolver; ISSUE-010 +1 IndentGuideLevelCache; Phase 21 M5 +35 durable memory types; Phase 21 M4 +34 session continuity types; Phase 21 M3 +21 usage/cost evidence types; Phase 21 M2 +34 trace evidence types; Phase 21 M1 +26 durable-record/storage types; Phase 20 M5 baseline 794).</summary>
    public const int M0TotalTopLevelTypes = 1021;

    /// <summary>M0 baseline public top-level type count (Phase 22/23 settings v4 migration +2 AgentsSettings/SettingsMigrationV3ToV4; Refactor 10 M1 +2 ThemeBinding/ThemeTokenParityTests; Phase 22.1 M1 +1 IEditorUiDispatcher).</summary>
    public const int M0PublicTopLevelTypes = 354;

    /// <summary>M0 baseline internal top-level type count (Refactor 10 M4b +4 AppButton/AppTextBox/ListRow/PanelChrome; Refactor 10 M4a +1 ControlThemeCatalog; Refactor 10 M2 +1 Elevation; Refactor 10 M1 +1 ThemeBinding internal helper; Phase 23 F1 +1 AgentInspectHost; Phase 22.4 M3 +3 AgentUsagePanel/AgentUsageSurfaceState/AgentUsageAggregationSemantics; Phase 22.4 M2 +2 AgentMemoryPanel/AgentMemorySurfaceState; Phase 22.3 M4 corrective +2 invocation counter types; Phase 22.3 M2 residual +3 cancel-ack seam types; Phase 22.3 M2 +2 AgentSessionEndStatus/Result; Phase 22.2 corrective +1 ACP runtime binding fingerprint; Phase 22.2 M1 +13 durable binding store types; ISSUE-011 +1 CodeFontResolver; ISSUE-010 +1 IndentGuideLevelCache; Phase 21 M5 +35 durable memory types; Phase 21 M4 +34 session continuity types; Phase 21 M3 +21 usage/cost evidence types; Phase 21 M2 +34 trace evidence types; Phase 21 M1 +26 durable-record/storage types; Phase 20 M5 baseline 443).</summary>
    public const int M0InternalTopLevelTypes = 667;
