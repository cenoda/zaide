...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (M6i: +1 ProjectSystem DI module).</summary>
    public const int M0TotalTopLevelTypes = 406;
    ...
    /// <summary>M0 baseline internal top-level type count (M6i: +1 ProjectSystem registration extension).</summary>
    public const int M0InternalTopLevelTypes = 60;
