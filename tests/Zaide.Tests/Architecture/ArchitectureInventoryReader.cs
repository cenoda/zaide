...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (M6j: +1 Language DI module).</summary>
    public const int M0TotalTopLevelTypes = 407;
    ...
    /// <summary>M0 baseline internal top-level type count (M6j: +1 Language registration extension).</summary>
    public const int M0InternalTopLevelTypes = 61;
