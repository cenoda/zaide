...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (M9c: +1 MainWindowActivationHost).</summary>
    public const int M0TotalTopLevelTypes = 413;
    ...
    /// <summary>M0 baseline internal top-level type count (M9c: +1 MainWindowActivationHost).</summary>
    public const int M0InternalTopLevelTypes = 67;
