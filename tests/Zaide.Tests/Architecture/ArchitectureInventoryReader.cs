...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Phase 14 M8 panel retirement).</summary>
    public const int M0TotalTopLevelTypes = 463;

    /// <summary>M0 baseline public top-level type count (Phase 14 M8 −2 panel view types).</summary>
    public const int M0PublicTopLevelTypes = 337;

    /// <summary>M0 baseline internal top-level type count (Phase 14 M8 −1 mirror coordinator).</summary>
    public const int M0InternalTopLevelTypes = 126;
