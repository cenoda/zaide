...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Phase 20 M1 +53 ACP protocol foundation types; Phase 19 M3 baseline 682).</summary>
    public const int M0TotalTopLevelTypes = 735;

    /// <summary>M0 baseline public top-level type count (Phase 18 M5 +4 public policy contracts/UI).</summary>
    public const int M0PublicTopLevelTypes = 350;

    /// <summary>M0 baseline internal top-level type count (Phase 20 M1 +53 ACP protocol foundation types; Phase 19 M3 baseline 332).</summary>
    public const int M0InternalTopLevelTypes = 385;
