...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Refactor 8 M4 +1 internal MainLayoutBuilder).</summary>
    public const int M0TotalTopLevelTypes = 448;
    ...
    /// <summary>M0 baseline internal top-level type count (Refactor 8 M4 +1 MainLayoutBuilder).</summary>
    public const int M0InternalTopLevelTypes = 109;
