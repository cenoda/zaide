...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Refactor 8 M3 +1 internal RightColumnHost).</summary>
    public const int M0TotalTopLevelTypes = 447;
    ...
    /// <summary>M0 baseline internal top-level type count (Refactor 8 M3 +1 RightColumnHost).</summary>
    public const int M0InternalTopLevelTypes = 108;
