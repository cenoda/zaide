...
{
    /// <summary>M0 baseline: non-nested, non-compiler-generated top-level types (Phase 17 M3 corrective +6 internal permission review types, M4 +4 proposal types).</summary>
    public const int M0TotalTopLevelTypes = 568;
    ...
    /// <summary>M0 baseline internal top-level type count (Phase 17 M3 corrective +6 internal permission review types, M4 +4 proposal types).</summary>
    public const int M0InternalTopLevelTypes = 231;
