...
public sealed class M5SettingsUiTests
{
    ...
    private static MainWindowViewModel CreateMainWindowViewModel()
    {
        ...
        var vm = new MainWindowViewModel(fileTree, editorTabs, terminalHost, panelHost, coordinator, router, townhall,
            sourceControl, TestProblemsFactory.Create(workspace, editorTabs), TestProjectWorkflowFactory.Create(), TestTestResultsFactory.Create(), workspace, ctxMock.Object);
        vm.Activate();
        return vm;
    }
