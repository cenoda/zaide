...
public sealed class EditorTabViewModelTabLifecycleTests
{
    ...
    /// </summary>
    private static (EditorTabViewModel Vm, Workspace Ws) CreateVmWithWorkspace()
    {
    ...
    /// </summary>
    private static EditorViewModel AddTab(Workspace ws, EditorTabViewModel vm, string path)
    {
