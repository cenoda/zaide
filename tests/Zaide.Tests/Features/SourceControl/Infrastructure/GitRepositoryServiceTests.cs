...
public class GitRepositoryServiceTests
{
    ...
    {
        using var workspace = TestTempDirectory.Create("zaide-repo-test-");
    ...
    {
        using var bareWorkspace = TestTempDirectory.Create("zaide-repo-test-");
        var barePath = bareWorkspace.Path;
        using var localWorkspace = TestTempDirectory.Create("zaide-repo-test-");
        var localPath = localWorkspace.Path;
