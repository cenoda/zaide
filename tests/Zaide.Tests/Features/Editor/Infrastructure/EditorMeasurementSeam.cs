...
public static class EditorMeasurementSeam
{
    ...
    /// </summary>
    public static async Task<EditorMeasurementSample> MeasureOpenEditSaveRestoreAsync(
        ...
        int sampleNumber)
    {
        ...
        try
        {
            ...
            if (!opened)
            {
                ...
                return new EditorMeasurementSample(
                    Area: "editor",
    ...
    /// </summary>
    public static async Task<EditorMeasurementSample> MeasureLargeDocumentLoadAsync(
        string fixturePath,
        int sampleNumber)
    {
...
/// <summary>
/// One timed sample produced by <see cref="EditorMeasurementSeam"/>.
/// </summary>
public sealed record EditorMeasurementSample(
    string Area,
