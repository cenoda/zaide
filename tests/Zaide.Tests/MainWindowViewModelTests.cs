...
public class MainWindowViewModelTests
{
        ...
        bool appendAssistantOutput = true)
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost, agentHost,
            mockCoordinator.Object, router, townhallViewModel, scViewModel, TestProblemsFactory.Create(workspace, editorTabs), TestProjectWorkflowFactory.Create(), TestTestResultsFactory.Create(), TestDebugSessionFactory.Create(), workspace, ProjectContextServiceMock());
        vm.Activate();
        return (vm, panel);
    }
        ...
        IAgentExecutionService executionService)
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost, agentHost,
            coordinator, router, townhallViewModel, scViewModel, TestProblemsFactory.Create(workspace, editorTabs), TestProjectWorkflowFactory.Create(), TestTestResultsFactory.Create(), TestDebugSessionFactory.Create(), workspace, ProjectContextServiceMock());
        vm.Activate();
