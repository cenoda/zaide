...
public class MainWindowViewModelTests
{
    ...
    private static MainWindowViewModel CreateViewModel(IFileService fileService)
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost, panelHost, coordinator, router, townhallViewModel, scViewModel, TestProblemsFactory.Create(workspace, editorTabs), workspace, ProjectContextServiceMock());
        vm.Activate();
        return vm;
    }
    ...
    public async Task TerminalStartupError_UpdatesStatusText()
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost2, panelHost2, coordinator2, router2, townhallViewModel2, scViewModel2, TestProblemsFactory.Create(workspace2, editorTabs), workspace2, ProjectContextServiceMock());
        vm.Activate();
        ...
        bool appendAssistantOutput = true)
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost, agentHost,
            mockCoordinator.Object, router, townhallViewModel, scViewModel, TestProblemsFactory.Create(workspace, editorTabs), workspace, ProjectContextServiceMock());
        vm.Activate();
        return (vm, panel);
    }
        ...
        IAgentExecutionService executionService)
    {
        ...
        var vm = new MainWindowViewModel(fileTreeViewModel, editorTabs, terminalHost, agentHost,
            coordinator, router, townhallViewModel, scViewModel, TestProblemsFactory.Create(workspace, editorTabs), workspace, ProjectContextServiceMock());
        vm.Activate();
