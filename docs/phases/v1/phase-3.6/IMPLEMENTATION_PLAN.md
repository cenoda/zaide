...
- [x] Read `docs/phases/v1/phase-3.6/BRIEF.md`
- [x] Read `docs/phases/v1/phase-3.5/IMPLEMENTATION_PLAN.md` (predecessor)
- [x] Read `docs/phases/v1/phase-3.5/TOFIX.md` (deferred items)
...
| `docs/phases/v1/phase-3.6/TOFIX.md` | **Create** |
