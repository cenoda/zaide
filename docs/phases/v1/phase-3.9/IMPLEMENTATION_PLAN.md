...
- [x] Read `docs/phases/v1/phase-3.9/BRIEF.md`
- [x] Re-read `docs/phases/v1/phase-3.8/IMPLEMENTATION_PLAN.md` and `TOFIX.md`
...
- [x] Split terminal tabs into `docs/phases/v1/phase-3.9.1/` so Phase 3.9 stays focused on UX polish
...
- Do not implement terminal tabs here; that work is split into `docs/phases/v1/phase-3.9.1/`
...
4. **Terminal tabs are out of scope for Phase 3.9.**
   They are now tracked separately in `docs/phases/v1/phase-3.9.1/` so this phase can stay focused on UX polish over the existing single-terminal design.
...
- `docs/phases/v1/phase-3.9/IMPLEMENTATION_PLAN.md`
- `docs/phases/v1/phase-3.9/TOFIX.md` (if needed)
- `docs/phases/v1/phase-3.9.1/BRIEF.md`
