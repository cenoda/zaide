...
- [x] Read `docs/phases/v1/phase-3.8/BRIEF.md`
- [x] Re-read `docs/phases/v1/phase-3.7/IMPLEMENTATION_PLAN.md` and closeout state
- [x] Re-read `docs/roadmap/PHASES.md`, `docs/architecture/OVERVIEW.md`, and `docs/CONVENTIONS.md`
- [x] Verify current terminal scope boundary against `docs/phases/v1/phase-3.9/BRIEF.md`
...
- [x] Create/update `docs/phases/v1/phase-3.8/TOFIX.md` with review findings
