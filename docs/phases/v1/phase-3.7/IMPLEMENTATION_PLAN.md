...
- [x] Read `docs/phases/v1/phase-3.7/BRIEF.md`
- [x] Re-read `docs/phases/v1/phase-3.6/IMPLEMENTATION_PLAN.md` and `TOFIX.md`
...
- [ ] Create/update `docs/phases/v1/phase-3.7/TOFIX.md` with review findings
