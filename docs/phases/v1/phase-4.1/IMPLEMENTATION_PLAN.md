...
- [ ] Confirm `docs/phases/v1/phase-4/IMPLEMENTATION_PLAN.md` has been converted to an umbrella pointing at this sub-phase
...
`docs/phases/v1/phase-4/IMPLEMENTATION_PLAN.md` for the umbrella and the other
...
- [x] `docs/phases/v1/phase-4/IMPLEMENTATION_PLAN.md` sub-phase table updated to mark 4.1 complete
