...
- [ ] Confirm Phase 4.1 is complete (activity entry model + agent-format decision landed; see `docs/phases/v1/phase-4.1/IMPLEMENTATION_PLAN.md` exit conditions)
...
`docs/phases/v1/phase-4.1/IMPLEMENTATION_PLAN.md`). The actual live shape,
...
- [x] `docs/phases/v1/phase-4/IMPLEMENTATION_PLAN.md` sub-phase table updated to mark 4.2 complete
