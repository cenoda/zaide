...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 M5 complete; M6 authorized only** (2026-07-20) — M7+ unauthorized |
...
**M6 only** is authorized for production work (conversation persistence + recovery).
