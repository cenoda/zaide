...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 M0 accepted; M1 authorized only** (2026-07-20) — M2+ unauthorized |
...
**M1 only** is authorized for production work (store navigation seams).
