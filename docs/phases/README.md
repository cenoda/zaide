...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 accepted and closed** (2026-07-21; accepted baseline `67da1394`) — [Phase 15 M0](v3/phase-15/IMPLEMENTATION_PLAN.md) accepted (2026-07-21); M1a and production implementation unauthorized |
...
M1a and production implementation remain unauthorized until a milestone is
explicitly authorized. Phase 16, Native Harness production, and ACP
