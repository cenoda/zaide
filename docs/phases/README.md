...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14, Phase 15, and Phase 17 closed** — **Phase 16 parked** — **Phase 18 M0 planning created** (implementation unauthorized); see each phase `TOFIX.md` for current work state |
...
Phase 18 remains unauthorized for implementation. M0 planning document created
at [`v3/phase-18/IMPLEMENTATION_PLAN.md`](v3/phase-18/IMPLEMENTATION_PLAN.md).
Phase 18 implementation requires explicit user acceptance of M0. See
