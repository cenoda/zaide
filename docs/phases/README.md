...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 M4 complete; M5 authorized only** (2026-07-20) — M6+ unauthorized |
...
**M5 only** is authorized for production work (per-conversation draft + unread).
