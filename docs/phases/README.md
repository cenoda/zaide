...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14, Phase 15, and Phase 17 closed** — **Phase 16 parked** — **Phase 18 M0–M5 complete** (M6 not started); see each phase `TOFIX.md` for current work state |
...
Phase 18 M0–M5 are complete. M6 closeout remains not started. See
