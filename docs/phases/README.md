...
| [`v2/`](v2/) | IDE Core Upgrade, Phase 8 through Phase 13 | In progress — Phase 8 (umbrella), Phase 9 (Editor UX), Phase 10 (C# LSP), and Phase 11 (Project Workflow) complete; Phase 12 DAP debugging M0–M5 complete, M6 next |
