...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 accepted and closed** (2026-07-21; accepted baseline `67da1394`) — Phase 15 M0 planning is eligible; production implementation unauthorized |
...
**Phase 15 may begin with its own M0 planning gate. Production implementation
remains unauthorized until that plan is accepted and its first milestone is
