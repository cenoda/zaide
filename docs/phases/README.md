...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 M0 accepted** (2026-07-20) — M1+ production unauthorized |
...
6.1–6.3, 7, and 8 are complete and closed. Phase 14 M0 lives at
[`v3/phase-14/IMPLEMENTATION_PLAN.md`](v3/phase-14/IMPLEMENTATION_PLAN.md)
(live-code audit, scope, persistence/recovery contract, milestones M1–M9).
**No Phase 14 production implementation is authorized** until a human
explicitly authorizes the next named milestone (M1 next).
