...
| [`v3/`](v3/) | AI-Native Orchestration, Phase 14 onward | **Phase 14 accepted and closed** (2026-07-21; accepted baseline `67da1394`) — **Phase 15 complete and closed** (2026-07-22) — **Phase 16 M0/M1/M2a complete**; **M2b is next eligible** under automatic progression, subject to its safety and technical gates |
...
single-candidate execution path eligible). **M2a was explicitly human-accepted on 2026-07-23** (standalone offline runner contract and fake-candidate core; no production behavior or upstream execution). **M2b is next eligible under automatic progression; later milestones remain gated by their required technical, security, provenance, and external-side-effect checks.**
