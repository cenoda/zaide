...
**Status:** M1, M2, M3, M4, M5, and M6 are complete and published; M7 is not started and not authorized.
...
**Next gate:** M6 review/acceptance; M7 remains not started and not authorized.
